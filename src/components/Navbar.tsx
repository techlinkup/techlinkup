...
const Navbar = () => {
  ...
  return (
    <div
      className={`${
        scroll || isOpen ? "bg-black !border-none" : "bg-transparent"
      } w-full fixed z-50 border-b-zinc-600 border-b-2 transition-all duration-700`}
    >
      <div
      ...
      >
        ...
        <div
          className={`${
            isOpen ? "block" : "hidden"
          } w-full lg:flex lg:items-center lg:w-auto mt-4 lg:mt-0 cursor-pointer`}
        >
